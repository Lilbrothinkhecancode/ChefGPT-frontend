...
<div class="pt-8 pl-24 pr-24">
	...
	<div class="flex flex-row gap-6">
		<div>
			<img
				class="items-start pb-4 max-w-sm rounded"
			...
			<div class="flex flex-row">
				<div class="meal prep button mr-2">
					<button
						class="bg-red-500 hover:bg-red-700 text-white font-semibold py-2 px-4 border border-red-600 rounded shadow flex items-center justify-center"
						on:click={save(data.recipe.title,data.recipe.image)}
					>
